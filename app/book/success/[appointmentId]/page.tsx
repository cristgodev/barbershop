        ...
        <div className="flex flex-col items-center justify-center min-h-screen w-full px-4 bg-zinc-50 dark:bg-zinc-950 py-12">
            ...
            <div className="bg-white dark:bg-zinc-900/30 rounded-[2.5rem] w-full max-w-[400px] shadow-sm overflow-hidden relative border border-zinc-200 dark:border-zinc-800">
                ...
                <div className="p-8 md:p-10 pt-12">
                    <div className="flex flex-col items-center text-center mb-10">
                        ...
                        <p className="text-5xl font-extrabold text-zinc-900 dark:text-white mb-2 tracking-tight font-serif" style={{ fontFamily: 'var(--font-cormorant), serif' }}>
                ...
                <div className="bg-zinc-50 dark:bg-zinc-900/80 p-8 flex flex-col items-center border-t border-zinc-200 dark:border-zinc-800 mt-4 rounded-b-[2.5rem]">
                    {/* Simulated barcode */}
                    <div className="w-full h-14 flex justify-between items-center opacity-30 mb-4 px-2">
                        {[...Array(35)].map((_, i) => (
                            <div key={i} className="bg-zinc-900 dark:bg-white h-full rounded-sm" style={{ width: Math.max(1.5, Math.random() * 5) + 'px' }}></div>
                        ))}
                    </div>
            ...
            <div className="mt-8 flex flex-col gap-3 w-full max-w-[400px]">
                ...
                <a 
                    ...
                    className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white px-6 py-4 rounded-2xl font-bold flex justify-center items-center gap-2 transition-all mt-2"
                >
                    Volver al Inicio
                </a>
            </div>
