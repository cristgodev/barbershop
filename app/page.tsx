      ...
      <section className="bg-transparent rounded-[2.5rem] py-16 flex flex-col md:flex-row items-center gap-12 justify-between relative">
        ...
        <div className="max-w-2xl space-y-8 relative z-10 w-full">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold tracking-tight leading-[1.05] font-serif" style={{ fontFamily: 'var(--font-cormorant), serif' }}>
            <span className="block mb-2 text-zinc-900 dark:text-white">Descubre Tu</span>
            <span className="italic block font-light text-yellow-600 dark:text-yellow-500">Próximo Estilo</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-xl font-medium">
            Reserva citas instantáneamente con los mejores barberos. O registra tu propia barbería y gestiona tu negocio como un maestro.
          </p>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 pt-4">
            ...
            <a href="/book" className="bg-zinc-100/50 hover:bg-zinc-200/50 dark:bg-zinc-900/50 dark:hover:bg-zinc-800/50 text-zinc-900 dark:text-white border border-zinc-200 dark:border-zinc-800 px-8 py-4 rounded-full font-semibold text-lg transition-colors w-full sm:w-auto text-center">
              Buscar Salones
            </a>
          </div>
        </div>
